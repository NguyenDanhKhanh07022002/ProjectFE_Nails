...
function PriceList() {
  ...
  const priceListOption1 = {
    ...
    priceOption: [
      ...
      { priceName: "Manikúra a obyčejné lakování O.P.I.", priceNumber: "250 Kč", priceTxt: "" },
      { priceName: "Manikúra a lakování CND Shellac (Barva)", priceNumber: "500 Kč", priceTxt: "" },
      { priceName: "Manikúra a lakování CND Shellac (Francie)", priceNumber: "550 Kč", priceTxt: "" },
    ],
  };
  const priceListOption2 = {
    ...
    priceOption: [
      ...
      { priceName: "Footlogix pedikúra klasik", priceNumber: "450 Kč", priceTxt: "" },
      { priceName: "Footlogix pedikúra s obyčajným lakovaním O.P.I", priceNumber: "500 Kč", priceTxt: "" },
      { priceName: "Footlogix pedikúra s gel-lakem", priceNumber: "590 Kč", priceTxt: "" },
      { priceName: "Footlogix pedikúra s CND Shellac", priceNumber: "650 Kč", priceTxt: "" },
      { priceName: "Lakovanie gel-lakem, shellac bez pedikúry", priceNumber: "350 Kč", priceTxt: "" },
    ],
  };
  const priceListOption3 = {
    ...
    priceOption: [
      { priceName: "Gelové / Akrylové nehty klasik", priceNumber: "300 Kč", priceTxt: "" },
      { priceName: "Gelové / Akrylové nehty s lakovaním", priceNumber: "450 Kč", priceTxt: "" },
      { priceName: "Nová aplikácia plus (+)", priceNumber: "50 Kč", priceTxt: "" },
      { priceName: "Dlouhé nehty plus (+)", priceNumber: "od 50 Kč", priceTxt: "" },
    ],
  };
  const priceListOption4 = {
    ...
    priceOption: [
      ...
      { priceName: "Komplet magnetický efekt", priceNumber: "100 Kč", priceTxt: "" },
    ],
  };
  const priceListOption5 = {
    ...
    priceOption: [
      ...
      { priceName: "Odstraněni gelových / akrylových nehtů", priceNumber: "150 Kč", priceTxt: "" },
      { priceName: "Odstraněni CND Shellac nehtů", priceNumber: "150 Kč", priceTxt: "" },
  ...
  const priceListOption6 = {
    ...
    priceOption: [
      { priceName: "Prodlužování řas", priceNumber: "700 Kč (nová aplikace)", priceTxt: "" },
      { priceName: "Prodlužování řas", priceNumber: "550 Kč (doplnění)", priceTxt: "" },
      { priceName: "Prodlužování řas 'volume'", priceNumber: "850 Kč (nová aplikace)", priceTxt: "" },
      { priceName: "Prodlužování řas 'volume'", priceNumber: "700 Kč (doplnění)", priceTxt: "" },
  ...
  const priceListOption7 = {
    ...
    title: "Masáze",
    priceOption: [
      { priceName: "Masáž nohou", priceNumber: "450 Kč (30 min)", priceTxt: "" },
      { priceName: "Masáž nohou", priceNumber: "850 Kč (60 min)", priceTxt: "" },
      { priceName: "THE SPA masáž (Tradiční VietNamská + olejová)", priceNumber: "430 Kč (60 min)", priceTxt: "" },
      { priceName: "THE SPA masáž (Tradiční VietNamská + olejová)", priceNumber: "830 Kč (60 min)", priceTxt: "" },
    ],
  };
  useEffect(() => {
    window.scrollTo(0, 0);
